...
function RecommendedVideos(){
  ...
  const getVideos = async(req,res)=>{
    const result = await fetch("http://localhost:3000/api/video");
  ...
  if(videos){
    ...
    //     <source src={`http://localhost:3000/api/video/${el.videopath}`}/>
    // </video>
...
//     <>
//     {videos.map(el=>{
//       return <video width={320}> <source src={`http://localhost:3000/api/video/${el.videopath}`}></source></video>
//     })}
//     </>
//   )  
  //   // <div className="recommended">
